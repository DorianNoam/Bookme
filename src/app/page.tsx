    ...
    <div style={{ fontFamily: 'Inter, sans-serif' }}>
      ...
      <header style={{ background: '#fff', borderBottom: '1px solid #F0EAE0', padding: '15px 0', position: 'sticky', top: 0, zIndex: 100 }}>
        <div className="header-container">
          <Link href="/" style={{ fontSize: 24, fontWeight: 900, color: NOIR, whiteSpace: 'nowrap', textDecoration: 'none' }}>
          ...
          <div className="header-actions">
            {isLoggedIn ? (
              <Link href="/dashboard" style={{ background: NOIR, color: '#fff', padding: '9px 20px', borderRadius: 4, fontWeight: 700, fontSize: 13, textDecoration: 'none' }}>Mon espace</Link>
            ) : (
              <>
      ...
      {/* ══════ HERO ══════ */}
      <section className="hero-section" style={{ position: 'relative', minHeight: 520, background: NOIR, display: 'flex', alignItems: 'center', overflow: 'hidden' }}>
        <img
        ...
        <div className="hero-content" style={{ position: 'relative', zIndex: 1, maxWidth: 1200, margin: '0 auto', padding: '60px 20px', width: '100%', boxSizing: 'border-box' }}>
          ...
          <h1 className="hero-title" style={{ fontSize: 'clamp(32px, 5vw, 50px)', fontWeight: 900, color: '#fff', marginBottom: 16, lineHeight: 1.1, maxWidth: 540, letterSpacing: -1 }}>
          ...
          <form onSubmit={handleSearch} className="hero-search" style={{ background: '#fff', borderRadius: 4, display: 'flex', maxWidth: 680, boxShadow: '0 8px 40px rgba(0,0,0,0.4)', overflow: 'hidden', flexWrap: 'wrap' }}>
            <div className="hero-search-field" style={{ flex: '1 1 200px', padding: '14px 20px', borderRight: '1px solid #F0EAE0' }}>
            ...
            <button type="submit" className="hero-search-btn" style={{ background: OR, color: '#fff', border: 'none', padding: '0 28px', fontWeight: 800, fontSize: 12, cursor: 'pointer', letterSpacing: 1, textTransform: 'uppercase' }}>Rechercher</button>
          </form>
        </div>
      </section>
      ...
      <div style={{ background: BG, padding: '10px 0', borderBottom: '1px solid #EDE5D8' }}>
        <div className="filters-bar" style={{ maxWidth: 1200, margin: '0 auto', padding: '0 20px', display: 'flex', gap: 8, overflowX: 'auto', alignItems: 'center' }}>
      ...
      <section style={{ padding: '80px 0', background: '#fff' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 20px' }}>
          ...
          <div className="section-title" style={{ fontSize: 32, fontWeight: 800, color: NOIR, marginBottom: 44, letterSpacing: -0.5 }}>Decouvrez nos Professionnels</div>
          <div className="carousel-container" style={{ display: 'flex', alignItems: 'center', gap: 60, minHeight: 400, flexWrap: 'wrap' }}>
            <div className="carousel-image" style={{ flex: 1, height: 400, borderRadius: 4, overflow: 'hidden', boxShadow: '0 10px 40px rgba(0,0,0,0.12)', minWidth: 280 }}>
              <img src={current.img} alt={current.cat} style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
            </div>
            <div className="carousel-text" style={{ flex: 1, minWidth: 280 }}>
              ...
              <h3 className="carousel-title" style={{ fontSize: 30, fontWeight: 800, color: NOIR, margin: '0 0 16px', letterSpacing: -0.5 }}>{current.title}</h3>
      ...
      <section style={{ background: BG, padding: '70px 0', borderTop: '1px solid #EDE5D8' }}>
        <div className="features-grid" style={{ maxWidth: 1200, margin: '0 auto', padding: '0 20px', display: 'flex', justifyContent: 'space-around', flexWrap: 'wrap', gap: 40, textAlign: 'center' }}>
          {[
      ...
      <section style={{ background: NOIR, color: '#fff', padding: '80px 20px', textAlign: 'center' }}>
        ...
        <h2 className="cta-title" style={{ fontSize: 34, marginBottom: 16, fontWeight: 900, letterSpacing: -0.5 }}>Vous etes un professionnel ?</h2>
