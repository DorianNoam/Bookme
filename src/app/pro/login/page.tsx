  ...
  return (
    <div style={{ fontFamily: 'Inter, sans-serif', background: NOIR, minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px 20px' }}>
        <div style={{ background: '#111', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 6, padding: '40px', width: '100%', maxWidth: 450 }}>
          
          <h1 style={{ fontSize: 24, fontWeight: 900, color: '#fff', marginBottom: 8, textAlign: 'center' }}>Espace Partenaire</h1>
